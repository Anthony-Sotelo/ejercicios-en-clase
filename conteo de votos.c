...
En la eleccion Hay cinco candidatos, los cuales se representan con los valores correspondientes entre1y 5.
El programa debe obtener el numero de votos de cada candidato y el porcentaje que obtuvo respecto al total de los votos
